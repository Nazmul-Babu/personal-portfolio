 <!-- ====== start contact ====== -->
 <section class="contact style-13">
    <div class="container">
        <div class="content">
            <div class="row gx-0 justify-content-between">
                <div class="col-lg-5">
                    <div class="contact-info">
                        <div class="section-head side-title mb-40 style-13">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="contact-form mt-4 mt-lg-0">
                       ...
                       <form action="{{ route('form') }}" method="POST"  >
                        ...
                        <input type="submit" name="submit" value="Submit Request" href="#0" class="btn rounded-pill text-white bg-orange3" target="_blank">
